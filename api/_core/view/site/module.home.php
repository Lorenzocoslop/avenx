						...
						<div class="row single-slide align-items-center d-flex">
							<div class="col-lg-5 col-md-6">
								<div class="banner-content">
									<h1>Nova<br>Coleção!</h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
										dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
									<div class="add-bag d-flex align-items-center">
										<a href="" class="primary-btn">Confira a Loja</a>
									</div>
								</div>
							</div>
							<div class="col-lg-7">
								<div class="banner-img">
									<img class="img-fluid" src="<?=__BASEPATH__?>img/banner/banner-img.png" alt="">
								</div>
							</div>
						</div>
						<!-- single-slide -->
			...
			<div class="row features-inner">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						...
						<h6>Política de Retorno</h6>
						<p>Retorno grátis em todas as compras</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						...
						<h6>Suporte 24/7</h6>
						<p>Suporte 24/7 para todas as compras</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
							<i class="bi bi-coin" style="font-size:40px"></i>
						</div>
						<h6>Pagamento Seguro</h6>
						<p>Pagamento seguro em muitas plataformas</p>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="single-product">
							...
							<div class="product-details">
								...
								<div class="prd-bottom">
									...
									<a href="" class="social-info">
										<span><i class="bi bi-arrows-move"></i></span>
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-6 no-padding exclusive-left">
					<div class="row clock_sec clockdiv" id="clockdiv">
						<div class="col-lg-12">
							<h1>Promoção exclusiva terminando!</h1>
							<p>Se apresse e garante o seu.</p>
						</div>
						<div class="col-lg-12">
					...
					<a href="" class="primary-btn">Confira já</a>
				</div>
						...
						<div class="single-exclusive-slider">
							...
							<div class="product-details">
								...
								<div class="add-bag d-flex align-items-center justify-content-center">
									<a class="add-btn" href=""><span><i class="bi bi-bag"></i></span></a>
