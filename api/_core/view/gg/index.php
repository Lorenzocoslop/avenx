...
<html lang="<?=$GLOBALS['Language']?>">
    ...
    <body class="<?= $view['page_class'] ?>">
        ...
        <?php if ($view['logged']) { ?> 
            ...
            <script src="https://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.9.2/ckeditor.js" nonce="<?=$HashNonce?>" integrity="sha512-OF6VwfoBrM/wE3gt0I/lTh1ElROdq3etwAquhEm2YI45Um4ird+0ZFX1IwuBDBRufdXBuYoBb0mqXrmUA2VnOA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
