...
if($action == 'send-email') {
    ...
    <div class="d-flex flex-column justify-content-between">
        ...
        <div class="text-white mb-3 small">
            ...
            <a id="reenviarCodigoLink" href="#" data-token="'.$token.'" data-userid="'.$objUsuario->get('id').'" class="fw-bold text-secondary">Reenviar código!</a>
        ...
        <div class="d-flex flex-wrap-reverse flex-lg-nowrap align-items-center gap-3">
            ...
            <a class="btn btn-secondary flex-fill col-sm-8" id="confirmarEmail" href="#">Verificar</a>
        </div>
    </div>
    ';         
