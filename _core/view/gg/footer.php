    ...
    <div class="py-3 px-5">
        <div class="px-md-5 d-flex justify-content-between gap-3">
            ...
            <?php if ($view['hasHeader']) { ?>
                ...
                <div class="btn-group dropup">
                    ...
                    <ul class="dropdown-menu bg-dark text-white text-center">
                        <li><a class="dropdown-item p-3 text-white">Bem vindo, <br><strong><?=$objSession->nome?></strong></a></li>
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item d-flex text-white align-items-center justify-content-center gap-2 logout" href="#" aria-label="Sair">
            ...
            <?php }else if($request->get('module') == '' || $request->get('module') == 'home'){?>
                ...
                <a class="btn btn-dark logout" href="javascript:;" aria-label="Sair">
                    <i class="ti ti-logout"></i>
                    Sair
                </a>
