...
class Security {
    ...
    public static function csrfGetTokenId() {
    ...
    public static function csrfGetToken() {
    ...
    public static function csrfIsValid($method='post') {
        if($method == 'post' || $method == 'get') {
            $post = $_POST;
            $get = $_GET;
            if(isset(${$method}[self::csrfGetTokenId()]) && (${$method}[self::csrfGetTokenId()] == self::csrfGetToken())) {
                return true;
            } else {
                return false;   
            }
