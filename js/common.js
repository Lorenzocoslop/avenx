...
const showTogglePassword = (input) => {
	...
	$(`
    <a href="#" aria-label="Show/Hide Password" class="text-primary text-decoration-none position-absolute top-50 end-0 p-2 translate-middle-y h5 r10p" data-type="togglePassword">
